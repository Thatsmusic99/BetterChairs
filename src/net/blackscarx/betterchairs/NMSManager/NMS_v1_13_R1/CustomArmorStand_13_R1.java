package net.blackscarx.betterchairs.NMSManager.NMS_v1_13_R1;
...
class CustomArmorStand_13_R1 extends EntityArmorStand {

    private boolean protect = true;

    private CustomArmorStand_13_R1(World world) {
        super(world);
    }
    ...
    public static ArmorStand spawn(Location location, Player p) {
        ...
        CustomArmorStand_13_R1 customEntity = new CustomArmorStand_13_R1(mcWorld);
    ...
    private boolean shouldDie(CustomArmorStand_13_R1 mount) {
