...
public class CustomArmorStand_13_R2 extends EntityArmorStand {
    ...
    private CustomArmorStand_13_R2(World world) {
        super(world);
    }
    ...
    public static ArmorStand spawn(Location location, Player p) {
        ...
        CustomArmorStand_13_R2 customEntity = new CustomArmorStand_13_R2(mcWorld);
    ...
    private boolean shouldDie(CustomArmorStand_13_R2 mount) {
